...
Version  : 1.7.1
Release  : 45
URL      : https://cran.r-project.org/src/contrib/ps_1.7.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/ps_1.7.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655671678
