...
Version  : 1.3.4
Release  : 24
URL      : https://cran.r-project.org/src/contrib/ps_1.3.4.tar.gz
Source0  : https://cran.r-project.org/src/contrib/ps_1.3.4.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1597173584
