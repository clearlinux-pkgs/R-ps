...
Version  : 1.7.0
Release  : 42
URL      : https://cran.r-project.org/src/contrib/ps_1.7.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/ps_1.7.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1650739185
